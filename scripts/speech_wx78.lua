...
--fallback to speech_wilson.lua         QUAGMIRE_CRATE = "Kitchen stuff.",
        ...
        FISHINGNET = "I, MERCIFUL WX-78, WILL SAVE THE ORGANICS FROM THE WATER",
        ANTCHOVIES = "THIS ORGANIC IS WORSE THAN MOST",
        ...
        ROCK_AVOCADO_BUSH = 
        {
			...
			DISEASED = "IT IS AFFLICTED WITH ORGANIC SICKNESS",
            DISEASING = "IT IS GETTING SICK. DISGUSTING",
			BURNING = "YES. IT IS BURNING",
		},
        ...
        ICEBERG =
        {
            GENERIC = "IT IS COLD LIKE METAL, BUT MORE INFERIOR",
            MELTED = "THE ICE HAS MELTED",
        },
        ICEBERG_MELTED = "THE ICE HAS MELTED",
