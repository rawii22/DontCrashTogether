...
function FoodAffinity:AddPrefabAffinity(prefab, bonus)
    self.prefab_affinites[prefab] = bonus
end
...
function FoodAffinity:RemovePrefabAffinity(prefab)
    self.prefab_affinites[prefab] = nil
end
...
function FoodAffinity:HasPrefabAffinity(food)
    return self.prefab_affinites[food.prefab] ~= nil
end
...
function FoodAffinity:GetAffinity(food)
    ...
    if self.prefab_affinites[food.prefab] ~= nil then
        table.insert(found_affinities, self.prefab_affinites[food.prefab])
    end
