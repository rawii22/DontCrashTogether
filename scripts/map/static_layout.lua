...
local function ConvertStaticLayoutToLayout(layoutsrc, additionalProps)
	...
	layout.ground_types = {
							...
							GROUND.OCEAN_COASTAL_SHORE,	GROUND.OCEAN_COASTAL,		GROUND.IMPASSABLE,		GROUND.OCEAN_BRINEPOOL, GROUND.UNDERROCK,	GROUND.MUD,					GROUND.QUAGMIRE_PEATFOREST,		GROUND.IMPASSABLE,
